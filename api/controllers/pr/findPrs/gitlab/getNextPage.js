...
const getNextPage = async (pagination, gitlab, username, searchYear, pullRequestData) => {
 try {
   ...
   if (hasNextPage(pagination)) {
     return await getNextPage(pagination, gitlab, username, searchYear, newPullRequestData);
   }
