  ...
  <div className="pb-8 flex justify-center">
    <div className="p-2" id="twitter-share">
      <a
        ...
        href={`https://twitter.com/intent/tweet?text=My progress on frogtoberfest ${pullRequestCount} / ${pullRequestAmount}&url=${HOSTNAME}/username/${username}&hashtags=frogtoberfest, frogtoberfest`}
        data-size="large"
      >
    ...
    >
      <a
        ...
        href={`https://www.facebook.com/sharer/sharer.php?u=${HOSTNAME}/username/${username}`}
      >
